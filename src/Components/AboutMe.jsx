...
import Me from "../Image/aboutMe.png";
...
const Container = styled.div`
  ...
  ${Mobile({ padding: "0px", height: "auto" })}
`;
...
const Image = styled.div`
  ...
  box-shadow: -50px -50px 0px 0px #333;
  padding: 10px;
...
const Right = styled.div`
  ...
  ${Mobile({ padding: "60x 0px", width: "100%" })}
...
const Description = styled.div`
  ...
  & h3 {
    ...
    ${Mobile({ textAlign: "center", padding: "0px 25px" })}
  }
`;
...
const PA = styled.p`
  ...
  font-weight: 600;
  /* background-color: red; */
  ${Mobile({ padding: "0px 25px", textAlign: "center" })}
`;
...
const PB = styled.p`
  ...
  font-size: 16px;
  /* background-color: red; */
  ${Mobile({ padding: "25px", fontSize: "17px" })}
`;
...
const Technologies = styled.div`
  ...
  ${Mobile({ flexWrap: "wrap", justifyContent: "flex-start" })}
  ...
  return (
    <Container>
      ...
      <Right>
        ...
        <Description>
          <PA>
            Hi, I am a self-taught web developer. I love creating fascinating
            stuff and making both static and functional websites.
          </PA>

          <PB>
            A few years ago I started my journey with NIELIT 'O' level diploma
            and got introduced to 'C' as my first programming language. I truly
            enjoyed learning it, completed my one-year diploma and started
            looking for a job. I had a hard time getting a job just based on a
            diploma, so I joined a BPO with the idea of pursuing further studies
            and getting back to the IT field. After completing some time there,
            I realized that I was slowing down and wasn't able to give
            sufficient time to my studies, so I quit that job and started
            learning Web-development. So far, I have learned a lot during this
            journey, and my next goal is to acquire sufficient knowledge to
            become a full-stack developer.
          </PB>
          <h3>I am comfortable in using the following technologies :</h3>
          <Technologies>
            <Tech themevalue={themevalue}>
              <svg
                className="techStack"
